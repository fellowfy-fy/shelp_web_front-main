    ...
    comments: [
      {
        ...
        createdAt: Date.parse("2020-05-12T23:50:21.817Z"),
        comment:
          "First comment With Chakra UI, I wanted to sync the speed of development with the speed of designWith Chakra UI, I wanted to sync the speed of development with the speed of designWith Chakra UI, I wanted to sync the speed of development with the speed of designWith Chakra UI, I wanted to sync the speed of development with the speed of design",
      },
      {
        id: "qwewqeqwe12",
        createdBy: {
      ...
      <Container mt={10} mb={20} maxW={"container.lg"}>
        ...
        <Flex gap={5}>
          ...
          <Box flex={5}>
            <HStack fontSize={15}>
              <Link to={`/${data.author.authorUsername}`}>
                <HStack>
                  ...
                  <Text fontWeight={"bold"}>{data.author.authorUsername}</Text>
                </HStack>
              </Link>
              <Text> • </Text>
              <Text color={"gray"}>{timeAgo(data.publishDate)}</Text>
            </HStack>
            ...
            <Flex align="center">
              <Text py={3} pr="2" textTransform={"uppercase"} fontWeight={600}>
                Comments
              </Text>
              <Divider />
            </Flex>
